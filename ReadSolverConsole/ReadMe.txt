========================================================================
    KONSOLENANWENDUNG: ReadSolverConsole-Projektübersicht
========================================================================

Diese ReadSolverConsole-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre ReadSolverConsole-Anwendung besteht.


ReadSolverConsole.vcxproj
...
ReadSolverConsole.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen ReadSolverConsole.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
