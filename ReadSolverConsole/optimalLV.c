...
strcpy(line_str, "UF UR RD RB LU LF DB DL FR UB DF BL UFR RFD RDB RBU LFU LUB DLB LDF");
...
/* ========================================================================= TODO */
   void  output_solution(Search_node  *node_arr, char *solution)
/* ------------------------------------------------------------------------- */
...
*solution = '\0';
for (ii = 0; ii < count; ii++)			// RG
{
	strcat(solution, twist_string[turn_list[ii]]);
	strcat(solution, " ");
}
printf(" %s", solution);
...
/* ========================================================================= */
   int  test_for_solution(Full_cube  *p_cube, Search_node  *node_arr,  char *solution)
/* ------------------------------------------------------------------------- */
...
output_solution(node_arr, solution);                    /*  solution !  */
...
/* ========================================================================= */
   void  search_tree(Full_cube  *p_cube, Search_node  *node_arr, char *solution)
/* ------------------------------------------------------------------------- */
...
while (p_node >= node_arr)
      ...
      if (p_node->remain_depth == 0)
         {
         if (test_for_solution(p_cube, node_arr, solution) &&
...
/* ========================================================================= */
   void  solve_cube(Cube  *p_cube, char* solution)
/* ------------------------------------------------------------------------- */
...
for (ii = start_depth; ii <= search_limit; ii += p_current_metric->increment)
    ...
    node_arr[1].twist = -1;
    search_tree(&full_cube_struct, node_arr, solution);
...
/* ========================================================================= TODO */
   int  initSolverCube( Metric_data *metric_data, Options *user_options)
/* ------------------------------------------------------------------------- */
{
...
/* ========================================================================= TODO */
   int  solveCube(char cube_str[], char solution[])
/* ------------------------------------------------------------------------- */
   {
	   int stat = 0;
	   Cube cube_struct;

	   stat= string_to_cube( cube_str, &cube_struct, 1);
...
/* ========================================================================= TODO */
   int  main(void)
   {
	   ...
	   initSolverCube( &metric_data, &user_options);
	   stat = solveCube( cube_input, solution);
